...
export async function GET(req: NextRequest) {
  ...
  let query = supabaseAdmin.from("clients").select("id, first_name, last_name, mrn, preferred_name, pronouns").eq("organization_id", orgId).eq("is_active", true).order("last_name").limit(15);
