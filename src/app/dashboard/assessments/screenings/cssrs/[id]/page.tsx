  ...
  return (
    <div className="max-w-3xl space-y-5">
      ...
      <div className="flex gap-3 pb-4">
        {patient && <Link href={`/dashboard/clients/${patient.id}`} className="border border-slate-200 text-slate-600 px-5 py-2.5 rounded-xl text-sm font-medium hover:bg-slate-50">View Patient</Link>}
