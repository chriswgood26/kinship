...
const SEVERITY = [
  { max: 4, label: "Minimal Depression", color: "bg-emerald-100 text-emerald-800", badge: "bg-emerald-50 border-emerald-200" },
  { max: 9, label: "Mild Depression", color: "bg-blue-100 text-blue-800", badge: "bg-blue-50 border-blue-200" },
  { max: 14, label: "Moderate Depression", color: "bg-amber-100 text-amber-800", badge: "bg-amber-50 border-amber-200" },
  { max: 19, label: "Moderately Severe Depression", color: "bg-orange-100 text-orange-800", badge: "bg-orange-50 border-orange-200" },
  { max: 27, label: "Severe Depression", color: "bg-red-100 text-red-800", badge: "bg-red-50 border-red-200" },
];
  ...
  return (
    <div className="max-w-3xl space-y-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900">PHQ-9 Assessment</h1>
      ...
      <div className={`rounded-2xl border p-6 ${severity.badge}`}>
        ...
        {q9 > 0 && (
          <div className="mt-4 bg-red-50 border border-red-200 rounded-xl px-4 py-3 text-sm text-red-800 font-semibold">
            ⚠️ Q9 (Suicidal ideation) endorsed — score: {q9}. Follow-up assessment and safety planning required.
          </div>
        )}
      </div>
